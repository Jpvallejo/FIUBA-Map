...
export const GRUPOS = {
    ...
    "Habilitada Parcial": { color: COLORS.habilitadasParcial[400] },
    "En Final": { color: COLORS.enfinal[400] },
    "Materias Obligatorias": { color: COLORS.obligatorias[400] },
    "Taller Formativo Docente 1": { color: COLORS.electivas[400] },
    "Taller Formativo Docente 2": { color: COLORS.electivas[50] },
    "Taller de Didactica Especifica": { color: COLORS.electivas[500] },
    "Fin de Carrera": {
...
export const CREDITOS = {
    ...
    "FormativoDocente1": {
        nombrecorto: "FormativoDocente1",
        nombre: "Taller Formativo Docente 1",
        color: "electivas",
        bg: COLORS.electivas[50],
    },
    "FormativoDocente2": {
        nombrecorto: "FormativoDocente2",
        nombre: "Taller Formativo Docente II",
        color: "electivas",
        bg: COLORS.electivas[50],
    },
    "DidacticaEspecifica": {
        nombrecorto: "DidacticaEspecifica",
        nombre: "Taller de Didactica Especifica",
        color: "electivas",
        bg: COLORS.electivas[50],
    },
